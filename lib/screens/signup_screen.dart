  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          "Sign Up",
          style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold,fontFamily: "Exo",color: Color.fromARGB(255, 55, 53, 53)),
        ),
      ...
      body: Container(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: <Widget>[
                 Lottie.asset('assets/ai_logo.json', width: 250, height: 250),
                const SizedBox(
                  height: 10,
                ),
