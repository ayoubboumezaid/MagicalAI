...
import 'package:magicalia/prompt/bloc/bloc/prompt_bloc.dart';
...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(child: Text("Image Generator AI 🤖", style: TextStyle(fontFamily: "Anta", fontSize: 21),)),
        leading: IconButton(
          icon: const Icon(
            Icons.arrow_back,
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        const Text(
                          "Enter your prompt",
                          style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, fontFamily: "Anta"),
                        ),
